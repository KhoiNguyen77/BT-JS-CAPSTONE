  ...
  let getProduct = axios({
    ...
    .then((resp) => {
      ...
      listAdidas.forEach((shoe, index) => {
        let relatedAdidas = resp.data.content[index].relatedProducts;
        console.log(relatedAdidas);
        ...
        <div class="container">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="./detail.html?productId=${shoe.id}&relatedProduct=${relatedAdidas}">More Info</a>
              </button>
...
getNike = () => {
  let getProduct = axios({
    ...
    .then((resp) => {
      ...
      let output = "";
      listNike.forEach((shoe, index) => {
        let relatedNike = resp.data.content[index].relatedProducts;
        output += `            <div class="col-12 col-sm-6 col-lg-3">
        <div class="container">
          <div class="card">
            <img src="${shoe.image}" class="card-img-top" alt="..." />
            <div class="card-body">
              ...
              <h5 class="card-title price">$${shoe.price}</h5>
              <button class="more-info">
              <a href="./detail.html?productId=${shoe.id}&relatedProduct=${relatedNike}">More Info</a>
              </button>
  ...
  let getProduct = axios({
    ...
    .then((resp) => {
      ...
      listVans.forEach((shoe, index) => {
        let relatedVans = resp.data.content[index].relatedProducts
        output += `            <div class="col-12 col-sm-6 col-lg-3">
        <div class="container">
          <div class="card">
            <img src="${shoe.image}" class="card-img-top" alt="..." />
            <div class="card-body">
              ...
              <h5 class="card-title price">$${shoe.price}</h5>
              <button class="more-info">
              <a href="./detail.html?productId=${shoe.id}&relatedProduct=${relatedVans}">More Info</a>
              </button>
